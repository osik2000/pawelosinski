    ...
    return (
        <section id="mainpage">
            ...
            <div className="content">
                <div className="text">
                    <p>
                        Hello, I am Paweł Osiński, a third-year student of computer science at the renowned Nicolaus
                    ...
                    <p>
                        ...
                        I invite you to learn about my achievements and explore my world of programming, skateboarding,
                        singing and healthy lifestyle.
